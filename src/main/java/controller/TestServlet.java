...
public class TestServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        // Get the selected category.jsp name and set it as an attribute
        String categoryName = request.getParameter("category.jsp");
        ...
        // Get the selected category.jsp book list and set it as an attribute
