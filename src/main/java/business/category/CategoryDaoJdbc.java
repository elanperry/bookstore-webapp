...
public class CategoryDaoJdbc implements CategoryDao {
    ...
    public Category findByCategoryId(long categoryId) {
        ...
        try (Connection connection = JdbcUtils.getConnection();
            ...
            throw new BookstoreQueryDbException("Encountered a problem finding category.jsp " + categoryId, e);
        }
        return category;
    }
    ...
    public Category findByName(String name) {
        ...
        try (Connection connection = JdbcUtils.getConnection();
            ...
            throw new BookstoreQueryDbException("Encountered a problem finding category.jsp named " + name, e);
        }
        return category;
    }
